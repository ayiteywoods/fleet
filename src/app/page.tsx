      ...
      <div className={`space-y-6 ${themeMode === 'dark' ? 'text-white' : 'text-gray-900'}`}>
        ...
        <div className="flex items-center mb-6">
          <div className="flex-shrink-0">
            <h1 className="text-3xl font-bold text-gray-700 dark:text-white">Dashboard Management</h1>
            <p className="text-sm text-gray-500 dark:text-gray-200">Real-time insights into your fleet operations</p>
          </div>
