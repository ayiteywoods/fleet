...
interface EditUserModalProps {
  isOpen: boolean
  onClose: () => void
  onUserUpdated: (userData: any) => void
  user: User | null
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updateData = {
        ...
        license_category: formData.license_category || null,
    ...
    >
      <div className={`relative ${themeMode === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto`}>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">Update the user information below</p>
        </div>
